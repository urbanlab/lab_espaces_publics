<aside id="filters-menu" class="filters slide-in lg:static lg:translate-x-0 lg:flex-col lg:w-1/3 lg:max z-10">
    ...
    <form method="POST" action="#" id="taxonomy-filter-form" class="space-y-4 lg:overflow-y-auto lg:max-h-96">
        ...
        @foreach ($taxonomies as $taxonomy)
            <div>
                <button type="button"
                        class="accordion flex justify-between w-full text-base text-left py-2 px-4 border-b border-black focus:outline-none">
